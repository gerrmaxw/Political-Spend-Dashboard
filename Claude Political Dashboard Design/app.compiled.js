...
function App() {
  ...
  function calendarStateOptions() {
    ...
    (Fapp.POLITICAL_WINDOWS || []).forEach(w => {
      String(w.state || "").split(/[\/,\s]+/).map(x => x.trim()).filter(Boolean).forEach(x => s.add(x));
    });
  ...
  return /*#__PURE__*/React.createElement(Stage, null, /*#__PURE__*/React.createElement(PBIHeader, {
    ...
    className: "page-body"
  }, /*#__PURE__*/React.createElement(SlicerDrawer, {
    filters: filters,
    setFilters: setFilters,
    options: slicerOptions,
    onClear: onClearFilters
  }), activePage === "overview" && /*#__PURE__*/React.createElement(OverviewPage, {
    filteredRows: filteredRows,
    measures: measures,
    filters: filters
  }), activePage === "prospects" && /*#__PURE__*/React.createElement(ProspectsPage, {
    filteredRows: filteredRows,
    measures: measures,
    filters: filters,
    tvFloor: tvFloor,
    setTvFloor: setTvFloor,
    cableTarget: cableTarget,
    setCableTarget: setCableTarget,
    cableOppFloor: cableOppFloor,
    setCableOppFloor: setCableOppFloor
  }), activePage === "trend" && /*#__PURE__*/React.createElement(TrendPage, {
    filteredRows: filteredRows,
    filters: filters
  }), activePage === "detail" && /*#__PURE__*/React.createElement(DetailPage, {
    filteredRows: filteredRows,
    filters: filters
  }), activePage === "race" && /*#__PURE__*/React.createElement(RacePage, {
    filteredRows: filteredRows,
    filters: filters
  }), activePage === "calendar" && /*#__PURE__*/React.createElement(CalendarPage, {
    filteredRows: filteredRows,
    filters: filters
  }), activePage === "pac" && /*#__PURE__*/React.createElement(PacPage, {
    filters: filters
  }), activePage === "results" && /*#__PURE__*/React.createElement(CompletedPage, {
    filteredRows: filteredRows,
    filters: filters
  }), activePage === "casestudy" && /*#__PURE__*/React.createElement(CaseStudyPage, {
    filteredRows: filteredRows,
    filters: filters
  }), activePage === "health" && /*#__PURE__*/React.createElement(HealthPage, {
    filteredRows: filteredRows,
    filters: filters
  })), /*#__PURE__*/React.createElement(PBITabs, {
    active: activePage,
