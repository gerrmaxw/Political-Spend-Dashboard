...
Use CivicAPI as the dashboard's certified election-results source for case-study triage. Load race detail responses into FactElectionResults and use candidate vote counts, vote share, winner flags, percent reporting, and last-updated fields when available.
